    ...
    class sdlApplication {
        protected:
            ...
            virtual void eventMouseFocus () = 0;
            virtual void eventMouseBlur () = 0;
            virtual void eventInputFocus () = 0;
            virtual void eventInputBlur () = 0;
            ...
            virtual void eventMouseMButtonDown (int x, int y) = 0;
            virtual void eventMouseMButtonUp (int x, int y) = 0;
